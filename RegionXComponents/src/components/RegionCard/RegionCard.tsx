...
import CardImageItem from '../../assets/images/CardImage.png';
...
const RegionCard: React.FC<RegionCardProps> = ({}) => {
    ...
    return (
        <div className='regionCardWrapper'>
            <RegionCardHeader cardImage={CardImageItem} cardName='Card Name 1' startTime='Start in 1 hr' endTime='End in 9 hr' coreIndex='Core index: 234' coreHours='4 hours' />
            <RegionCardTasks coreOcupaccy={30} consumed={24} currentUsage={69} />
            <div className='regionCardWrapper-labels'>
            <LabelCard label='Renewable' color='orangeDark' variant='primary' />
